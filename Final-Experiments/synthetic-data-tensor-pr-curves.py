...
fig2, *_ = create_precision_recall_curves_with_errorbars(
    algorithms={
        ...
        "TeraLasso": 10**np.linspace(-4., 0., args.num_lambdas),
        "Random": np.linspace(0.01, 1., args.num_lambdas),
    },
    samples=args.samples,
    attempts=args.attempts,
    ds={
        "3-Axis Tensor": args.size, # Named weird to make plot pretty
        "Middle Axis": args.size,
        "Right Axis": args.size
    },
    structure=[
        ("3-Axis Tensor", "Middle Axis", "Right Axis")
    ],
    sparsities={
        "3-Axis Tensor": args.sparsity,
        "Middle Axis": args.sparsity,
        "Right Axis": args.sparsity
    },
    verbose=args.verbose,
    title=f"PR curves on {args.size}x{args.size}x{args.size} tensor",
    pre_existing_ax={"3-Axis Tensor": ax},
